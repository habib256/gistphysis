...
if (workbox) {
  ...
  workbox.precaching.precacheAndRoute([
    ...
    // Ajoutez ici d'autres ressources essentielles (images, polices, etc.)
    // Par exemple, si vous avez les icônes du manifest :
    ...
    new workbox.strategies.NetworkFirst({
      ...
      plugins: [
        new workbox.cacheable_response.CacheableResponsePlugin({
          statuses: [0, 200] // Met en cache les réponses réussies ou opaques (pour le offline fallback)
        })
      ]
    })
  );
